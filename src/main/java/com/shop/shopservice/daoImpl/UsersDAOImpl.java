...
//	}
	...
	public User getUserByMobileNumber(String mobileNo) {
		User user = entityManager.createNamedQuery("User.findByMobileNumber", User.class).setParameter("mobileNo", mobileNo).getSingleResult();
		return user;
	}
